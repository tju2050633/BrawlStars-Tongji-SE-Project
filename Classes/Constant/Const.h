...
const int SHELLY_BULLET_RANGE = 100;//射程
...
const int PRIMO_AD = 100;		//攻击力AttackDamage
const int PRIMO_MS = 50;		//移速MoveSpeed
const int PRIMO_AI = 1;		//攻击间隔AttackInterval
const int PRIMO_EB = 1000;		//能量条EnergeBar
...
const int STU_AI = 1;		//攻击间隔AttackInterval
const int STU_EB = 1000;		//能量条EnergeBar

/*熊 属性*/

const int BEAR_HP = 4000;		//血量HealthPoint
const int BEAR_AD = 400;		//攻击力AttackDamage
const int BEAR_MS = 50;		//移速MoveSpeed
const int BEAR_AI = 1;		//攻击间隔AttackInterval
